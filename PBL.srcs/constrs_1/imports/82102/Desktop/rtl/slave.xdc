...
set_property PULLUP true [get_ports {otp_req}]

set_property PACKAGE_PIN B11 [get_ports {otp_sclk}]
set_property IOSTANDARD LVCMOS33 [get_ports {otp_sclk}]
set_property PULLUP true [get_ports {otp_sclk}]
# otp_cmd[1:0] (Host ¡æ Device)
...
set_property DRIVE 8 [get_ports {otp_ack}]
set_property SLEW FAST [get_ports {otp_ack}]

set_property PACKAGE_PIN D12 [get_ports {otp_dout[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {otp_dout[0]}]
set_property DRIVE 8 [get_ports {otp_dout[0]}]
set_property SLEW FAST [get_ports {otp_dout[0]}]

set_property PACKAGE_PIN E15 [get_ports {otp_dout[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {otp_dout[1]}]
set_property DRIVE 8 [get_ports {otp_dout[1]}]
set_property SLEW FAST [get_ports {otp_dout[1]}]

set_property PACKAGE_PIN E16 [get_ports {otp_dout[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {otp_dout[2]}]
set_property DRIVE 8 [get_ports {otp_dout[2]}]
set_property SLEW FAST [get_ports {otp_dout[2]}]

set_property PACKAGE_PIN D15 [get_ports {otp_dout[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {otp_dout[3]}]
set_property DRIVE 8 [get_ports {otp_dout[3]}]
set_property SLEW FAST [get_ports {otp_dout[3]}]
## Pmod Header JB
